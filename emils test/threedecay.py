...
out = lmfit.minimize(residue, par,method = 'leastsq')

# write error report
lmfit.report_fit(out)

#Corner plot
bay = lmfit.minimize(residue, method='emcee', nan_policy='omit', burn=300, steps=5000, thin=20,params=out.params, is_weighted=True, progress=True)
